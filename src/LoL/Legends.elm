...
katarina = 
    ...
    , abilities = 
        ...
        , spotlight = { cooldown = 1, damage = 1, range = 1, useType = AoE, name = " ", castTime = "", video = "https://www.youtube.com/embed/soCg5RbgYIA" }
...
kindred = 
    ...
    , abilities = 
        ...
        , spotlight = { cooldown = 1, damage = 1, range = 1, useType = AoE, name = " ", castTime = " ", video = "https://www.youtube.com/embed/h0Pwn7G-eLE" }
...
yuumi = 
    ...
    , abilities = 
        { p = { cooldown = 1, damage = 1, range = 1, useType = Target, name = "Bop 'n' Block", castTime = "None ", video = "https://d28xe8vt774jo5.cloudfront.net/champion-abilities/0350/ability_0350_P1.webm" }
        , q = { cooldown = 1, damage = 1, range = 1, useType = Target, name = "Prowling Projectile", castTime = "0.25", video = "https://d28xe8vt774jo5.cloudfront.net/champion-abilities/0350/ability_0350_P1.webm" }
        , w = { cooldown = 1, damage = 1, range = 1, useType = AoE, name = "You and Me!", castTime = "None", video = "https://d28xe8vt774jo5.cloudfront.net/champion-abilities/0350/ability_0350_W1.webm" }
        , e = { cooldown = 1, damage = 1, range = 1, useType = Target, name = "Zoomies", castTime = "0.035", video = "https://d28xe8vt774jo5.cloudfront.net/champion-abilities/0350/ability_0350_E1.webm" }
        , r = { cooldown = 1, damage = 1, range = 1, useType = AoE, name = "Final Chapter", castTime = "None", video = "https://d28xe8vt774jo5.cloudfront.net/champion-abilities/0350/ability_0350_R1.webm" }
        , spotlight = { cooldown = 1, damage = 1, range = 1, useType = AoE, name = "Yuumi Champion Spotlight" , castTime = " ", video = "https://www.youtube.com/embed/TYkvBijQccA" }
